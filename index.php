        ...
        <div class = "content"><!--body content holder-->
            <div class = "container">
                <div class = "col-md-12"><!--body content title holder with 12 grid columns-->
                    <h1 style="color:#000000; font-size:42px ; font-style:bold "><strong>  Register your Favourite events:</strong></h1><!--body content title-->
                ...
                <section>
                    <div class="container">
                        <div class="col-md-6"><!--image holder with 6 grid columns-->
                            <img src="images/techno2.jpg" class="img-responsive">
                        </div>
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                        
                            <h1 style="color:#5B3413 ; font-size:38px ;" ><u><strong>Technical Events</strong></u></h1><!--title-->
                            <p style="font-size:20px ;"><!--content-->
                                EMBRACE YOUR TECHNICAL SKILLS BY PARTICIPATING IN OUR VARIOUS TECHNICAL EVENTS!
                            </p>
            ...
            <div class="row">
                <section>
                    <div class="container">
                        <div class="col-md-6"><!--image holder with 6 grid columns-->
                            <img src="images/gaming1.jpg" class="img-responsive">
                        </div>
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            <h1 style="color:#5B3413 ; font-size:38px ;"><strong><u>Gaming Events</u></strong></h1><!--title-->
                            <p style="font-size:20px ;"><!--content-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            <h1 style="color:#5B3413 ; font-size:38px ;"><strong><u>On-Stage Events</strong></u></h1><!--title-->
                            <p style="font-size:20px ;"><!--content-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        <div class="col-md-6"><!--image holder with 6 grid columns-->
                            <img src="images/offstage1.jpg" class="img-responsive">
                        </div>
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            <h1 style="color:#5B3413 ; font-size:38px ;"><strong><u>Off-Stage Events</u></strong></h1><!--title-->
                            <p style="font-size:20px ;"><!--content-->
